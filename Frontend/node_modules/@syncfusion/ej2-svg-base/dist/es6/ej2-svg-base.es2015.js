...
let Tooltip = class Tooltip extends Component {
    ...
    renderText(isRender) {
        ...
        const options = new TextOption(this.element.id + '_text', this.marginX * 2, (this.marginY * 2 + this.padding * 2 + (this.marginY === 2 ? this.controlName === 'RangeNavigator' ? 5 : 3 : 0)), anchor, '');
